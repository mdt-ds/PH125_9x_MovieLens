...
For this reason I have commented out this part on the script in order to allow running the script without error if memory of computer is not enough. The script commented out runs in about 10 minutes on my laptop.
